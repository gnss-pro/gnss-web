...
/**
 * <p>Description: JT808 0x9302指令参数</p>
 ...
 * @date 2018-9-14
 */
@ApiModel("0x9302云台调整焦距控制")
@Data
@DownCommand(messageId = 0x9302, respMessageId = 0x0001, desc = "云台调整焦距控制")
public class Command9302Param implements IDownCommandMessage {

    @ApiModelProperty(value = "逻辑通道号", required = true, position = 1)
    @Range(min = 1, max = 127, message = "逻辑通道号范围1-127")
    private int channelId;

    @ApiModelProperty(value = "焦距调整方向(0:焦距调大,1:焦距调小)", required = true, position = 2)
    @Range(min = 0, max = 1, message = "焦距调整方向为0或1")
    private int mode;
    ...
    public String toString() {
        ...
        msgBodyItems.put("焦距调整方向", mode == 0 ? "0:焦距调大" : "1:焦距调小");
