...
/**
 * <p>Description: JT808 0x9304指令参数</p>
 ...
 * @date 2018-9-14
 */
@ApiModel("0x9304云台雨刷控制")
@Data
@DownCommand(messageId = 0x9304, respMessageId = 0x0001, desc = "云台雨刷控制")
public class Command9304Param implements IDownCommandMessage {
