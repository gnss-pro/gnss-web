...
/**
 * <p>Description: JT808 0x8600指令参数</p>
 ...
 * @date 2020/4/26
 */
@ApiModel("0x8600设置圆形区域")
@Getter
@Setter
@DownCommand(messageId = 0x8600, respMessageId = 0x0001, desc = "设置圆形区域")
public class Command8600Param implements IDownCommandMessage {
    ...
    @Valid
    private List<CircleRegion> itemList;
    ...
    public byte[] buildMessageBody(TerminalProto terminalInfo) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < itemCount; i++) {
                CircleRegion region = itemList.get(i);
                //生成区域ID
