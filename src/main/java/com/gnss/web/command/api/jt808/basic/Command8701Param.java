...
/**
 * <p>Description: JT808 0x8701指令参数</p>
 ...
 * @date 2019-9-14
 */
@ApiModel("0x8701行驶记录参数下传命令")
@Getter
@Setter
@DownCommand(messageId = 0x8701, respMessageId = 0x0001, desc = "行驶记录参数下传命令")
public class Command8701Param implements IDownCommandMessage {
