...
/**
 * <p>Description: JT808 0x8603指令参数</p>
 ...
 * @date 2019-12-14
 */
@ApiModel("0x8603删除矩形区域")
@Getter
@Setter
@DownCommand(messageId = 0x8603, respMessageId = 0x0001, desc = "删除矩形区域")
public class Command8603Param implements IDownCommandMessage {
