...
/**
 * <p>Description: JT808 0x8605指令参数</p>
 ...
 * @date 2019-12-14
 */
@ApiModel("0x8605删除多边形区域")
@Getter
@Setter
@DownCommand(messageId = 0x8605, respMessageId = 0x0001, desc = "删除多边形区域")
public class Command8605Param implements IDownCommandMessage {
